...
class clik_Glasses extends database {

    // Création d'attributs qui correspondent à chacun des champs de la table clik_Glasses
     ...
     * @return type
     */
    public function getGlassesList() {
        $query = 'SELECT `id`,`glasses` FROM `clik_Glasses`';
